...
puts "Oak : Right!"
puts "     So your name is #{your_name}!"
puts "     This is my grandson."
puts "     He's been your rival since you were a baby. "
puts "     ...Erm, what is his name again?"

rival_name = gets.chomp

puts "Oak : That's right!"
puts "      I remember now!"
puts "      His name is #{rival_name}!#{your_name}!"
